...
<div className="flex items-center justify-center p-4">
  <div className="m-6 sm:m-12 lg:m-20 p-6 sm:p-12 lg:p-20 rounded-xl bg-white/5 max-w-3xl mx-auto">      
  <p className="text-white text-center text-base md:text-lg lg:text-2xl leading-relaxed px-2 sm:px-0">
