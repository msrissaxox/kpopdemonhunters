const questions = [
  {
    question:
      "What is the most exciting part of getting ready for a new song or performance?",
    options: [
      {
  ...
  {
    question:
      "If you could have a special magical tool to help your group, what would it be?",
    options: [
      {
  ...
  {
    question:
      "What do you do if a teammate breaks a rule for a good reason, like helping someone?",
    options: [
      {
  ...
  {
    question:
      "When you are given a new uniform, which part do you love the most?",
    options: [
      {
  ...
  {
    question:
      "Which role would you naturally take on in your K-Pop Demon Hunter group?",
    options: [
      {
